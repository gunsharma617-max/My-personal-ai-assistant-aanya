      ...
      <main className="workspace">
        ...
        <div className="workspace-grid">
          <section className="assistant-space" aria-label="Aanya voice assistant">
            ...
            <div className="dock-caption"><span><ShieldCheck size={12} />Your voice. Your control.</span><span>Built to listen. Designed to understand.</span><span>Founder – Aakash Kainthla</span></div>
